# -*- coding: utf-8 -*-
"""
Created on Thu Jul 13 20:42:05 2023
...
#spliting data in to training set and test set
...
#y_pred to y_true comparison
np.set_printoptions(precision=3)
y_comparison = np.concatenate((y_pred.reshape(len(y_pred),1), y_test.reshape(len(y_test),1)),1)
